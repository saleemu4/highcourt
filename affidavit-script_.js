document.addEventListener('DOMContentLoaded', function() {
    ...
    const affidavitRequestModal = document.getElementById('affidavitRequestModal');
    ...
    // Open affidavit request modal
    requestBtn.addEventListener('click', function() {
        affidavitRequestModal.classList.add('active');
    });
    ...
    // Close modal (for confirmation screen)
    if (closeModal) {
        closeModal.addEventListener('click', function(e) {
            e.preventDefault();
            affidavitRequestModal.classList.remove('active');
        });
    }
    ...
    window.addEventListener('click', function(e) {
        ...
        if (e.target === affidavitRequestModal) {
            affidavitRequestModal.classList.remove('active');
        }
    });
        ...
        affidavitTypeCards.forEach(card => {
            card.addEventListener('click', function() {
                ...
                if (this.dataset.type === 'other') {
                    ...
                    document.getElementById('summaryType').textContent = this.querySelector('.affidavit-type-title').textContent;
                }
            });
        });
